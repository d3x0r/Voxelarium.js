...
var status_line;
	this.init = function init(scene) {
		...
		var strings = [];
		strings.push( makeText( "roll", "rgba(255,64,255,0.95)",[-300 + 150, 0, 150 ]) )
		strings.push( makeText( "yaw", "rgba(255,64,255,0.95)",[0 + 150, 0, 150 ]) )
		strings.push( makeText( "pitch", "rgba(255,64,255,0.95)",[300 + 150, 0, 150 ]) )

		strings.push( makeText( "roll", "rgba(64,64,255,0.95)", [-300 + 150, 300-40, 150]) )
		strings.push( makeText( "yaw", "rgba(64,64,255,0.95)", [-300 + 150, 300-40, 150]) )
		strings.push( makeText( "pitch", "rgba(64,64,255,0.95)", [-300 + 150, 300-40, 150]) )

		strings.push( makeText( "pitch", "rgba(64,64,255,0.95)", [-300 + 150, -300 - 0, 150 ] ) )
		strings.push( makeText( "yaw", "rgba(64,64,255,0.95)", [-300 + 150, -300 - 40, 150 ] ) )
		strings.push( makeText( "roll", "rgba(64,64,255,0.95)", [-300 + 150, -300 - 80, 150 ] ) )

		strings.push( makeText( "yaw", "rgba(64,64,255,0.95)", [0 + 150, -300 - 0, 150 ] ) )
		strings.push( makeText( "pitch", "rgba(64,64,255,0.95)", [0 + 150, -300 - 40, 150 ] ) )
		strings.push( makeText( "roll", "rgba(64,64,255,0.95)", [0 + 150, -300 - 80, 150 ] ) )

		strings.push( makeText( "roll", "rgba(64,64,255,0.95)", [300 + 150, -300 + 0, 150 ] ) )
		strings.push( makeText( "pitch", "rgba(64,64,255,0.95)", [300 + 150, -300 - 40, 150 ] ) )
		strings.push( makeText( "yaw", "rgba(64,64,255,0.95)", [300 + 150, -300 - 80, 150 ] ) )


		strings.push( makeText( "pitch", "rgba(64,64,255,0.95)", [-300 + 150, -600 - 0, 150 ] ) )
		strings.push( makeText( "roll", "rgba(64,64,255,0.95)", [-300 + 150, -600 - 40, 150 ] ) )
		strings.push( makeText( "yaw", "rgba(64,64,255,0.95)", [-300 + 150, -600 - 80, 150 ] ) )

		strings.push( makeText( "yaw", "rgba(64,64,255,0.95)", [0 + 150, -600 - 0, 150 ] ) )
		strings.push( makeText( "roll", "rgba(64,64,255,0.95)", [0 + 150, -600 - 40, 150 ] ) )
		strings.push( makeText( "pitch", "rgba(64,64,255,0.95)", [0 + 150, -600 - 80, 150 ] ) )

		strings.push( makeText( "roll", "rgba(64,64,255,0.95)", [300 + 150, -600 + 0, 150 ] ) )
		strings.push( makeText( "yaw", "rgba(64,64,255,0.95)", [300 + 150, -600 - 40, 150 ] ) )
		strings.push( makeText( "pitch", "rgba(64,64,255,0.95)", [300 + 150, -600 - 80, 150 ] ) )
		...
		makeText( "ALL(new)", "rgba(64,255,255,0.95)", [ -300+150, 300+80, 150 ] )
		makeText( "ALL(old)", "rgba(64,255,255,0.95)", [ 0+150, 300+80, 150 ] )

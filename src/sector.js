...
import {makeVoxelRef} from "./voxelRef.js";
...
export class Sector {
	...
	enableGeometry() {
		this.solid_geometry = this.cluster.mesher.getGeometryBuffer();
		this.transparent_geometry = this.cluster.mesher.getGeometryBuffer();
	...
	getCube( x, y, z ) {
		...
		return { mass:this.data.mass[offset], type:this.data.data[offset] };
	}
